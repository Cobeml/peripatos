  ...
  return (
    <>
      ...
      <div className="min-h-screen flex flex-col w-full bg-black items-center justify-center overflow-auto rounded-md text-pink-100">
        ...
        <div className="min-h-screen flex flex-col items-center justify-center">
          <ContainerScroll>
            <div className="flex flex-col items-center justify-center">
              ...
              <div className="px-16 md:px-30 lg:px-60">
        ...
        <div className="px-16 md:px-30 lg:px-60 relative flex flex-col justify-center">
        ...
        <div className="h-[40rem] min-h-screen w-full rounded-md bg-neutral-950 relative flex flex-col items-center justify-center antialiased">
          ...
          <div className="mx-auto p-4">
            <h1 className="relative z-10 text-large font-bold text-center">
              Join the waitlist
            </h1>
            <p></p>
